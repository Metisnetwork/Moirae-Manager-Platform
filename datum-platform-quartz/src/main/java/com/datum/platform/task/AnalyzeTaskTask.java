...
public class AnalyzeTaskTask {
    ...
    public void run() {
        ...
        try {
            sysService.sync(DataSyncTypeEnum.ANALYZE_TASK.getDataType(),DataSyncTypeEnum.ANALYZE_TASK.getDesc(),//1.根据dataType同步类型获取新的同步时间DataSync
