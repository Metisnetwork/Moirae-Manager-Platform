...
import com.moirae.rosettaflow.req.job.*;
import com.moirae.rosettaflow.service.IJobService;
import com.moirae.rosettaflow.task.JobManager;
import com.moirae.rosettaflow.vo.PageVo;
import com.moirae.rosettaflow.vo.ResponseVo;
import com.moirae.rosettaflow.vo.job.JobVo;
import com.moirae.rosettaflow.vo.job.QueryWorkflowVo;
...
public class JobController {
    ...
    public ResponseVo<PageVo<JobVo>> listJob(@RequestBody @Valid ListJobReq listJobReq) {
        ...
        IPage<JobDto> jobDtoPage = jobService.list(listJobReq.getCurrent(), listJobReq.getSize(), listJobReq.getJobName(), listJobReq.getProjectId());
