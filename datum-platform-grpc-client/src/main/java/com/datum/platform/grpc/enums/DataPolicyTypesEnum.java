...
@Getter
public enum DataPolicyTypesEnum {
    ...
    DataPolicyTypesEnum(Integer value, String desc) {
        this.value = value;
        this.desc = desc;
    }

    private static Map<Integer, DataPolicyTypesEnum> map = new HashMap<>();
    static {
        for (DataPolicyTypesEnum value : DataPolicyTypesEnum.values()) {
            map.put(value.getValue(),value);
        }
    }
    public static DataPolicyTypesEnum find(Integer value) {
